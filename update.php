            ...
            <div class="row">
                <div class="col-md-6 text-center mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="model_name" value="<?php echo $row['Model_name']; ?>" class="form-control">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" name="Parking_charges" value="<?php echo $row['Parking_charges']; ?>" class="form-control">
                    </div>
